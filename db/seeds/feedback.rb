puts "Seeding Feedback for Submissions (excluding user_id 77 Kawaguchi Ryo)..."
...
submissions = Submission.where.not(user_id: 77, challenge_id: 19)
...
puts "ALL DONE - Seeded Feedback for Submissions (excluding user_id 77 Kawaguchi Ryo)"
